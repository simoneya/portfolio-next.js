...
export default function About({ pageInfo }: Props) {
  return (
      <motion.div
         ...
         >
        <h3 className="absolute top-24 uppercase tracking-[20px] text-[#9BA4B5] text-2xl">About</h3>
        ...
        <motion.img
          ...
          viewport={{
            ...
            <div className="space-y-10 px-0 md:px-10">
                <h4 className="text-4xl font-semibold">A <span className="underline decoration-[#FF6000]/50">little</span> background over here</h4>
