...
const Home = ({pageInfo, skills, projects, socials, experiences}: Props) => {
  return (
    <div className="bg-[rgb(224,77,1)] text-white h-screen snap-y snap-mandatory overflow-y-scroll overflow-x-hidden z-0 scrollbar scrollbar-thumb-green-400 scrollbar-track-pink-400/20">
      <Head>
